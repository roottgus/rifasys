...
class UpdateRifaRequest extends FormRequest
{
    ...
    /**
     * Prepara datos para validación: normaliza premios.
     */
    protected function prepareForValidation(): void
    {
        ...
        $filtered = collect($rawPrem)
            ->filter(function ($p) {
                // Filtrar solo si tiene tipo de premio y tipo_loteria_id
                return !empty($p['tipo_premio'])
    ...
    /**
     * Reglas de validación para actualizar una rifa.
     */
